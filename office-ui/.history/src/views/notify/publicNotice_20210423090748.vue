<template>
    <div style="display: flex;align-items: center;overflow: hidden;height: 20px;margin-top: 0px; margin-left: 20px; position: absolute; width:100%; z-index: 999; -moz-border-radius: 10px; -webkit-border-radius: 10px; border-radius: 10px;">
