  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="任务状态" prop="state">
        <el-select v-model="queryParams.state" placeholder="请选择任务状态" clearable  size="small">
          <el-option 
    ...
    <el-table v-loading="loading" :data="taskdetailedList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="需求编号" align="center" prop="xqid" width="140"/>
      ...
      <el-table-column label="需求问题" align="left" prop="xqquestion" width="220"/>
      <el-table-column label="接口问题" align="left" prop="jkquestion" width="220"/>
      <el-table-column label="测试问题" align="left" prop="csquestion" width="220"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="需求编号" prop="xqid">
          <el-input v-model="form.xqid" placeholder="请输入需求编号" v-if="title!='添加开发任务表'" v-hasRole="['admin']"/>
          <el-input v-model="form.xqid" placeholder="请输入需求编号" v-else ref='addinput'/>
        </el-form-item>
        <el-form-item label="任务名称" prop="taskname">
        ...
        <el-form-item label="前台开发" prop="qdname" >
          <el-input v-model="form.qdname" placeholder="请输入前台开发" v-if="title!='添加开发任务表'" v-hasRole="['admin']" />
          <el-input v-model="form.qdname" placeholder="请输入前台开发" v-else ref='addinput1'/>
        </el-form-item>
...
<script>
import { listTaskdetailed, getTaskdetailed, delTaskdetailed, addTaskdetailed, updateTaskdetailed, exportTaskdetailed } from "@/api/jobtask/taskdetailed";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除开发任务表编号为"' + xqids + '"的数据项?', "警告", {
