  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        width="220"
      >
       <el-select v-model="jkquestion" multiple>
        <el-option v-for="item in userOptions" :key="item.postId" :label="item.postName" :value="item.postId" :disabled="item.status == 1"></el-option>
       </el-select>
      </el-table-column>
      <el-table-column
        label="测试问题"
