<template>
    <div style="display: flex;align-items: center;overflow: hidden;height: 20px;margin-top: 5px; position: absolute; width:100%">
    <img src="@/assets/image/horn.jpg" height="30" width="30"/>
      <div class="text-container" v-show="show_text" @click="click_view" style="width: 100%; background-color: antiquewhite;">
