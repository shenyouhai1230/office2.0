  ...
  <div class="app-container">
    ...
    >
      ...
      <template slot-scope="scope">
       <el-select multiple v-model="scope.row[scope.column.property]"  >
        <el-option v-for="item in userOptions" :key="item.nick_name" :label="item.nick_name" :value="item.user_id" :disabled="false"></el-option>
       </el-select>
      </template>
      </el-table-column>
      <el-table-column
