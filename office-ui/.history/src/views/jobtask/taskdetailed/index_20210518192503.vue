<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="上线时间" prop="endtime">
        <el-input
      ...
      <el-form-item label="规模估算" prop="kfdays">
      ...
      <el-form-item label="性能测试" prop="usedmanhours">
      ...
      <el-form-item label="质验文档" prop="totalmanhours">
    ...
    >
      ...
      <el-table-column label="上线时间" align="center" prop="endtime" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="上线时间" prop="endtime">
          <el-input v-model="form.endtime" placeholder="请输入上线时间" />
        </el-form-item>
        <el-form-item label="业务人员" prop="ywname">
...
export default {
  ...
  created() {
    ...
    this.getUserList()
    this.getDicts("scale_ estimate_status").then(response => {
      this.kfdaysOptions = response.data;
    });
    this.getDicts("performance_test_status").then(response => {
      this.usedmanhoursOptions = response.data;
    });
    this.getDicts("quality_archive_status").then(response => {
      this.totalmanhoursOptions = response.data;
    });

  },
  methods: {
     // 规模估算状态字典翻译
    kfdaysFormat(row, column) {
      return this.selectDictLabel(this.kfdaysOptions, row.kfdays);
    },
    // 性能测试状态字典翻译
    usedmanhoursFormat(row, column) {
      return this.selectDictLabel(this.usedmanhoursOptions, row.usedmanhours);
    },
    // 质验文档状态字典翻译
    totalmanhoursFormat(row, column) {
      return this.selectDictLabel(this.totalmanhoursOptions, row.totalmanhours);
    },
