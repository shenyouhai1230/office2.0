  ...
  <div class="app-container">
    ...
    >
      ...
      <template slot-scope="scope">
       <el-select v-model="scope.row.jkquestion" multiple placeholder="{{scope.row.jkquestion}}">
        <el-option v-for="item in userOptions" :key="item.user_id" :label="item.nick_name" :value="item.user_id" :disabled="false"></el-option>
       </el-select>
      </template>
      </el-table-column>
      <el-table-column
